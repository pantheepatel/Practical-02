...
internal class Customer_Account
{
    ...
    private long customer_accountNo; // private variable so that it can not be accessible to instance
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Customer_Account Account1 = new Customer_Account(1234567890, "Customer Name 1");
